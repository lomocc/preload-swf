...
package com.junkbyte.console 
{
	...
	public class Console extends Sprite {
		...
		private function stageAddedHandle(e:Event=null):void{
			...
			stage.addEventListener(KeyboardEvent.KEY_DOWN, _kb.keyDownHandler, false, int.MAX_VALUE, true);
			stage.addEventListener(KeyboardEvent.KEY_UP, _kb.keyUpHandler, false, int.MAX_VALUE, true);
		}
